 ...
 */
public class HuMatchThread extends AsyncTask<String, Integer, List<ImageItem>> {

    Context c;
    public AlertDialog dialog;
    public AlertDialog.Builder builder;

    public HuMatchThread(Context c) {
        this.c = c;
    }
    ...
    protected List<ImageItem> doInBackground(String... urls) {
        ...
        if (vector != null) {
            ...
            for (int i = 0; i < len; i++) {
                ...
                item.setResult(HuMatch.calShapeDiff(Constant.ORG_PATH + "/" + vector.get(i)));
