 ...
 */
public class GaborMatchThread extends AsyncTask<String, Integer, List<ImageItem>> {

    Context c;
    public AlertDialog dialog;
    public AlertDialog.Builder builder;

    public GaborMatchThread(Context c) {
        this.c = c;
    }
    ...
    protected List<ImageItem> doInBackground(String... urls) {
        ...
        if (vector != null) {
            ...
            for (int i = 0; i < len; i++) {
                ...
                item.setResult(GaborMatch.calGaborDiff(Constant.ORG_PATH + "/" + vector.get(i)));
