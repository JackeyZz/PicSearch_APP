...
public class SIFTMatchImageThread extends AsyncTask<String, Integer, List<ImageItem>> {

    Context c;
    public AlertDialog dialog;
    public AlertDialog.Builder builder;

    public SIFTMatchImageThread(Context c) {
        this.c = c;
    }
    ...
    protected List<ImageItem> doInBackground(String... urls) {
        ...
        if (vector != null) {
            ...
            for (int i = 0; i < len; i++) {
                ...
                item.setResult(SIFTMatch.match(tem,tem2,vector.get(i)));
